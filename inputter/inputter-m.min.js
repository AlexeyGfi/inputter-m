...
"free";this.defaultValue="";break;default:this.fieldType="numeric",this.defaultValue="0"}var a=this.getAttribute("data-empty-value");"undefined"!==typeof a&&null!==a&&(this.defaultValue=a);if(!this.linkAdded){(a=this.getAttribute("data-css-file-mtime"))||(a="cached");let c=this.getAttribute("data-css-file");c||="/inputter-m/inputter/inputter-m.css";if(c&&a){const b=document.createElement("link");b.rel="stylesheet";b.href=c+"?v="+a;b.addEventListener("load",()=>{this.updateWidth()});this.linkAdded=
!0;this.shadowRoot.appendChild(b)}}this.mode=this.getAttribute("data-mode");this.mode||(this.mode="online");if(a=this.getAttribute("data-min-width"))this.container.style.minWidth=`${a}px`,this.input.style.minWidth=`${a}px`;this.input.placeholder=this.getAttribute("placeholder")||this.defaultValue;(this.additionalClass=this.getAttribute("data-additional-class"))&&this.container.classList.add(this.additionalClass);this.allowNegative="true"===this.getAttribute("is-allow-negative");this.numSuffix=this.getAttribute("data-suffix");
this.setSuffix(!0);this.value=a=this.getAttribute("value");this.stableValue=this.input.value=a;this.updateWidth();"approvable"===this.mode?(this.inputFocused=!1,this.input.addEventListener("focus",()=>{"0"===this.input.value&&"numeric"===this.fieldType&&(this.input.value="");this.inputFocused=!0}),this.input.addEventListener("input",()=>{this.postfix();this.updateWidth();this.lastValue=this.input.value;this.dispatchEvent(new Event("inputMove"))}),this.approveOrReject=()=>{this.approveReady?(this.stableValue=
this.value=this.lastValue,this.approveReady=!1,this.dispatchEvent(new Event("change"))):(this.lastValue=this.value=this.input.value=this.stableValue,this.dispatchEvent(new Event("reject")));this.dispatchEvent(new Event("inputMove"));this.dispatchEvent(new Event("input"))},this.input.addEventListener("keydown",c=>{if("Enter"===c.key||"Tab"===c.key)this.approveReady=!0,this.approveOrReject(),this.blur();"Escape"===c.key&&(this.approveReady=!1,this.approveOrReject(),this.blur())}),"undefined"===typeof this.approver&&
